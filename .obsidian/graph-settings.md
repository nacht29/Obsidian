...
- English (layer: 2, role: hub, parent: Language)
...
### Hubs (layer 4)
- Technical Skills (layer: 4, role: hub, parent: BCG)
...
- SQL (role: leaf, parent: Technical Skills)
- GCP (role: leaf, parent: Technical Skills)
- Looker Studio (role: leaf, parent: Technical Skills)
- Watermarking (role: leaf, parent: Technical Skills)
...
- Roles (role: leaf, parent: Business Logic)
- Acronym Rules (role: leaf, parent: English)
